Shader "Custom RP/Disney PBR"
{
    Properties
    {
        ...
        _ClearCoatGloss("Clear Coat Gloss", Range(0, 1)) = 0.5
    }
    ...
    SubShader
    {
        Pass // CustomLit Pass
        {
            ...
            #pragma vertex   DisneyPBRPassVertex
            #pragma fragment DisneyPBRPassFragment

            #include "../ShaderLibrary/Common.hlsl"
            #include "Includes/DisneyPBRInput.hlsl"
            #include "Includes/DisneyPBRPass.hlsl"
